...
import type { FaultInjection } from './types.js';
...
`);
        ...
        case 'fault': {
          ...
          switch (faultType) {
            case 'signal-loss': faults.sacnSignalLoss = true; break;
            case 'timeout': faults.networkTimeout = true; break;
            case 'slow': faults.responseDelay = 2000; break;
            case 'drop': faults.dropPacketRate = 0.3; break;
            case 'errors': faults.sacnPacketErrors = 0.1; break;
            default:
...
function findDevice(simulator: DmxReceiverSimulator, query: string) {

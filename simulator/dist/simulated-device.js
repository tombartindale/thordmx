...
export class SimulatedDevice {
    ...
    port;
    faultInjection = {};
    sacnSimulationInterval = null;
    heapDecayInterval = null;
    constructor(deviceConfig, port) {
